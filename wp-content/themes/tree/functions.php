...
function register_post_types() {
	register_taxonomy('trees_cat', array('faq'), array(
		'label'                 => 'Категория дерева', // определяется параметром $labels->name
		'labels'                => array(
			'name'              => 'Категории деревьев',
			'singular_name'     => 'Категория деревьев',
			'search_items'      => 'Искать Категорию деревьев',
			'all_items'         => 'Все Категории деревьев',
			'parent_item'       => 'Родит. категория дерева',
			'parent_item_colon' => 'Родит. категория дерева:',
			'edit_item'         => 'Ред. категорию дерева',
			'update_item'       => 'Обновить Категорию дерева',
			'add_new_item'      => 'Добавить Категорию дерева',
			'new_item_name'     => 'Новая Категорая деревьев',
			'menu_name'         => 'Категория дерева',
		),
		'description'           => 'Категория для раздела проектоы', // описание таксономии
		'public'                => true,
		'show_in_rest'        	=> true,
		...
		'hierarchical'          => true,
		'rewrite'             => array( 'slug'=>'trees', 'with_front'=>false, 'pages'=>true, 'feeds'=>false, 'feed'=>false,'hierarchical'=>false ),
		'show_admin_column'     => true, // Позволить или нет авто-создание колонки таксономии в таблице ассоциированного типа записи. (с версии 3.5)
	) );
	register_post_type('trees', array(
		'labels' => array(
			'name'               => 'Деревья', // основное название для типа записи
			'singular_name'      => 'Деревья', // название для одной записи этого типа
			'add_new'            => 'Добавить дерево', // для добавления новой записи
			'add_new_item'       => 'Добавление дерева', // заголовка у вновь создаваемой записи в админ-панели.
			'edit_item'          => 'Редактирование дерева', // для редактирования типа записи
			'new_item'           => 'Новое дерево', // текст новой записи
			'view_item'          => 'Смотреть дерево', // для просмотра записи этого типа.
			'search_items'       => 'Искать дерево', // для поиска по этим типам записи
			'not_found'          => 'Не найдено', // если в результате поиска ничего не было найдено
			'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине
			'parent_item_colon'  => '', // для родителей (у древовидных типов)
			'menu_name'          => 'Деревья', // название меню
		),
		'public'              => true,
		...
		'taxonomies'          => array('trees_cat'),
		'has_archive'         => 'trees',
		'has_archive'         => 'trees',
		'rewrite'             => array( 'slug'=>'tree', 'with_front'=>false, 'pages'=>true, 'feeds'=>false, 'feed'=>false ),
		'query_var'           => true,
	) );
...
add_image_size( 'item-thumb', 324, 245 );
